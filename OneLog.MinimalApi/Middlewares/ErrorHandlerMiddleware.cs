using OneLog.Application.Behaviours.ExceptionHandlers;
using System.Net;

namespace OneLog.MinimalApi.Middlewares
{
    public class ErrorHandlerMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
                ...
                Dictionary<string, string[]> errors = new()
            {
                ...
                var responseModel = new Wrapper.Response<string>()
                {
                    Succeeded = false,
                ...
                switch (error)
                {
                    case ApiException e:
                        ...
                        responseModel = new Wrapper.Response<string>()
                        {
                            Succeeded = false,
